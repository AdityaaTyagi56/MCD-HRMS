          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left">
                ...
                {myPayslips.map(slip => (
                    ...
                    <td className="px-6 py-4 text-gray-600">₹{slip.basicSalary.toLocaleString()}</td>
                    <td className="px-6 py-4 text-red-500">-₹{slip.deductions.toLocaleString()}</td>
                    <td className="px-6 py-4 font-bold text-gray-800">₹{slip.netSalary.toLocaleString()}</td>
                    <td className="px-6 py-4">
                    ...
                    <tr key={slip.id} className="hover:bg-gray-50 transition-colors">
                      <td className="px-6 py-4 align-middle">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div className="text-xs text-gray-500">ID: MCD-{slip.userId.toString().padStart(4, '0')}</div>
                            </div>
                        </div>
                      </td>
                      <td className="px-6 py-4 align-middle">
                      ...
                      <td className="px-6 py-4 text-sm align-middle">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-gray-600 font-medium">{slip.daysPresent}</span>
                        </div>
                      </td>
