        ...
        <div className="space-y-6 animate-in fade-in duration-500">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-gray-600">KPI-driven automatic grading based on Attendance, Grievances & Tasks</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
                    <div className="flex justify-between items-start">
                        <div>
                            <p className="text-gray-600 font-medium mb-1">Avg Attendance Score</p>
                ...
                <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
                    <div className="flex justify-between items-start">
                        <div>
                            <p className="text-gray-600 font-medium mb-1">Critical Review Needed</p>
                        ...
                        <tbody className="divide-y divide-gray-200">
                            {sortedEmployees.map(emp => (
                                <tr key={emp.id} className="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="px-6 py-4 align-middle">
                                        <div className="flex items-center gap-2">
                                            <div className="w-16 h-2 bg-gray-100 rounded-full overflow-hidden">
                                                <div className={`h-full rounded-full ${emp.performance.attendanceScore > 80 ? 'bg-green-500' :
                                    ...
                                    <td className="px-6 py-4 align-middle">
                                        <span className={`text-sm font-medium ${emp.performance.grievanceScore < 70 ? 'text-red-700' : 'text-gray-700'}`}>
                                            {100 - emp.performance.grievanceScore}% Negative
                                        </span>
                                    </td>
                                    <td className="px-6 py-4 align-middle">
                                        <span className="text-sm text-gray-700">{emp.performance.taskCompletion}%</span>
                                    </td>
                                    <td className="px-6 py-4 align-middle">
                                        <span className={`w-8 h-8 flex items-center justify-center rounded-lg font-bold text-sm ${emp.performance.overallGrade === 'A+' || emp.performance.overallGrade === 'A' ? 'bg-green-100 text-green-700' :
