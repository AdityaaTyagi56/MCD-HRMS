        ...
        <div className="bg-white rounded-2xl p-6 shadow-soft border border-neutral-200/50">
          ...
          <div className="space-y-4">
            {filteredLeaves.slice(0, 5).map((leave) => (
              <div key={leave.id} className="flex items-center justify-between p-4 bg-neutral-50 rounded-xl border border-neutral-200/50 hover:bg-neutral-100 transition-colors">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-medium text-neutral-900">{leave.type} Leave</p>
